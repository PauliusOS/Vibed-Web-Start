...
export default function TermsOfServicePageV2() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <motion.p
              ...
              className="text-[#16101e]/70 text-base"
            >
          ...
          <motion.div
            ...
            className="bg-[#f4f4f4] rounded-[24px] p-6 sm:p-8 md:p-10 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06),inset_0_4px_12px_rgba(255,255,255,0.95)]"
          >
            <div className="prose prose-lg max-w-none text-[#16101e]/80">

              {/* Introduction */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Agreement</h2>
              ...
              {/* Services */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Our Services</h2>
              ...
              {/* Client Obligations */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Client Obligations</h2>
              ...
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Intellectual Property</h2>
                <p className="mb-4 leading-relaxed">
              ...
              {/* Disclaimers */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Disclaimers</h2>
              ...
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Limitation of Liability</h2>
                <p className="mb-4 leading-relaxed">
              ...
              {/* Confidentiality */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Confidentiality</h2>
                <p className="leading-relaxed">
              ...
              {/* Termination */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Termination</h2>
                <p className="leading-relaxed">
              ...
              {/* Governing Law */}
              <section className="mb-8">
                <h2 className="text-[#16101e] text-xl font-semibold mb-4">Governing Law</h2>
                <p className="leading-relaxed">
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Questions about these Terms? Contact us at <a href="mailto:legal@sylcroad.com" className="text-[#09f] hover:underline">legal@sylcroad.com</a> or <a href="mailto:support@sylcroad.com" className="text-[#09f] hover:underline">support@sylcroad.com</a>.
                </p>
              </section>
