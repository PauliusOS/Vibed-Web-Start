            ...
            >
              ...
              {userType === 'company' && (
                <form onSubmit={handleCompanySubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full h-auto py-3 px-6 text-base font-medium rounded-xl bg-[#16101e] text-white transition-shadow duration-200 hover:shadow-lg hover:bg-[#16101e] cursor-pointer"
                    style={{
                      boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)'
                    }}
                  >
