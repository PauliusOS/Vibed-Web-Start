...
const GLOBE_CONFIG: COBEOptions = {
  ...
  mapBrightness: 1.2,
  baseColor: [1, 1, 1],
  markerColor: [59 / 255, 130 / 255, 246 / 255], // Blue
  glowColor: [1, 1, 1],
  markers: [
...
const COLORS = {
  light: {
    ...
    marker: [59 / 255, 130 / 255, 246 / 255] as [number, number, number], // Blue
  },
  dark: {
    base: [0.4, 0.4, 0.4] as [number, number, number],
    glow: [0.24, 0.24, 0.27] as [number, number, number],
    marker: [96 / 255, 165 / 255, 250 / 255] as [number, number, number], // Blue
  },
};
