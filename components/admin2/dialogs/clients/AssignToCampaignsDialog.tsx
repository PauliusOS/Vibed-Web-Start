...
interface AssignToCampaignsDialogProps {
  ...
  client: Client;
  campaigns: Campaign[];
  onAssign: (campaignIds: string[]) => Promise<void>;
}

export function AssignToCampaignsDialog({
  open,
  onOpenChange,
  client,
  campaigns,
  ...
  const handleAssign = async () => {
    ...
    try {
      await onAssign(Array.from(selectedCampaigns));
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <DialogDescription className="mt-1">
                Assign {client.companyName} to campaigns
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-sm">
                  ...
                  <ul className="text-white/80 space-y-1">
                    <li>
                      • {client.companyName} will be assigned to{" "}
                      {selectedCampaigns.size} campaign
                      {selectedCampaigns.size !== 1 ? "s" : ""}
                    </li>
                    <li>
                      • Client will gain access to view and manage assigned campaigns
                    </li>
                    <li>
                      • Client will receive notifications about campaign updates
                    </li>
                  </ul>
                </div>
              </div>
