...
const navItems = [
  { label: "Overview", href: "/admin3", icon: LayoutDashboard },
  { label: "Campaigns", href: "/admin3/list", icon: FolderKanban },
  { label: "All Campaigns", href: "/admin3/campaigns", icon: Target },
  { label: "Analytics", href: "/admin3/analytics", icon: BarChart3 },
  { label: "Invites", href: "/admin3/invitations", icon: Mail },
];

export function Admin3Navbar() {
  ...
  const getCurrentPage = () => {
    if (pathname === "/admin3") return null;
    const item = navItems.find(item => pathname.startsWith(item.href) && item.href !== "/admin3");
      ...
      <div className="border-b border-white/[0.08]">
        <div className="flex h-16 items-center px-5 sm:px-6 gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link href="/admin3" className="flex items-center gap-2 group">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith("/admin3/settings")
...
export function Admin3MobileNav() {
  ...
  const mobileItems = [
    { label: "Home", href: "/admin3", icon: LayoutDashboard },
    { label: "Campaigns", href: "/admin3/list", icon: FolderKanban },
    { label: "New", href: "/admin3/new", icon: Plus, special: true },
    { label: "Analytics", href: "/admin3/analytics", icon: BarChart3 },
    { label: "Invites", href: "/admin3/invitations", icon: Mail },
  ];
