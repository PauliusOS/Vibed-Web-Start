...
export function CreatorPayoutCard({
  ...
  const canProceedStep1 = selectedMethod && parseFloat(amount) > 0 && parseFloat(amount) <= availableBalance;
  const canSubmit = accountHolder && (
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderColor: isHovered ? "rgba(34, 197, 94, 0.25)" : "rgba(34, 197, 94, 0.12)",
        boxShadow: isHovered 
        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              ...
              style={{ 
                backgroundColor: step === 2 ? "rgb(34, 197, 94)" : "rgba(255, 255, 255, 0.1)" 
              }}
            />
            <div
              className="w-2 h-2 rounded-full transition-colors"
              style={{ 
                backgroundColor: step === 2 ? "rgb(34, 197, 94)" : "rgba(255, 255, 255, 0.2)" 
              }}
            />
          </div>
        </div>
        <p className="text-sm" style={{ color: FRAMER_TEXT_COLORS.secondary }}>
          {step === 1 ? "Select amount and payment method" : "Enter your payment details"}
        </p>
      </div>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              >
                {currency}{pendingBalance.toLocaleString(undefined, { minimumFractionDigits: 2 })}
              </p>
            </div>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {isSuccess ? (
            ...
            >
              ...
              >
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="rgb(34, 197, 94)" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </motion.div>
              <h4 className="text-lg font-semibold mb-2" style={{ color: FRAMER_TEXT_COLORS.primary }}>
                Payout Requested!
              </h4>
              <p className="text-sm" style={{ color: FRAMER_TEXT_COLORS.secondary }}>
                {currency}{amount} will be transferred within 2-3 business days
              </p>
            </motion.div>
          ) : step === 1 ? (
            <motion.div
            ...
            >
              ...
              <div className="space-y-2">
                <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Amount to withdraw</Label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="0.00"
                    className="pl-8 text-lg font-semibold h-12 bg-transparent border-white/10 focus:border-green-500/50"
              ...
              {/* Payment Method Selection */}
              <div className="space-y-2">
                <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Payment Method</Label>
                      ...
                      >
                        ...
                        >
                          <method.Icon
                            className="w-5 h-5"
                            style={{
                              color: isSelected ? "rgb(34, 197, 94)" : FRAMER_TEXT_COLORS.muted,
                            }}
                          />
                        </div>
                        <span
            ...
            >
              <div className="space-y-2">
                <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Account Holder Name</Label>
                <Input
                  value={accountHolder}
                  onChange={(e) => setAccountHolder(e.target.value)}
                  placeholder="John Doe"
                  className="bg-transparent border-white/10 focus:border-green-500/50"
                />
              </div>

              {(selectedMethod === "paypal" || selectedMethod === "venmo") ? (
                <div className="space-y-2">
                  <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Email Address</Label>
                  <Input
                    type="email"
                    value={email}
                ...
                <>
                  <div className="space-y-2">
                    <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Bank Name</Label>
                    <Input
                      value={bankName}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Account Number</Label>
                      <Input
                        value={accountNumber}
                    ...
                    <div className="space-y-2">
                      <Label style={{ color: FRAMER_TEXT_COLORS.secondary }}>Routing Number</Label>
                      <Input
                        value={routingNumber}
