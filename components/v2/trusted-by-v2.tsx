...
export function TrustedByV2() {
  ...
  return (
    <section className="relative py-16 sm:py-20 border-t border-black/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.h2
          ...
          className="text-[#16101e] text-3xl sm:text-4xl font-bold text-center mb-12 sm:mb-16"
        >
      ...
      <div className="flex animate-scroll">
        {duplicatedLogos.map((logo, index) => (
          <div
            key={index}
            className="flex-shrink-0 mx-12 w-40 h-20 flex items-center justify-center opacity-40 hover:opacity-100 transition-opacity"
          >
